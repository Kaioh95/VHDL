...
-- Design Ports Information
-- s[0]	=>  Location: PIN_AD3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- s[1]	=>  Location: PIN_AD1,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- cout	=>  Location: PIN_AC1,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \i0|s~combout\ = \b[0]~input_o\ $ (\a[0]~input_o\)
...
\i1|s~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \i1|s~0_combout\ = \a[1]~input_o\ $ (\b[1]~input_o\ $ (((\b[0]~input_o\ & \a[0]~input_o\))))
...
-- Equation(s):
-- \i1|cout~0_combout\ = (\a[1]~input_o\ & ((\b[1]~input_o\) # ((\b[0]~input_o\ & \a[0]~input_o\)))) # (!\a[1]~input_o\ & (\b[0]~input_o\ & (\a[0]~input_o\ & \b[1]~input_o\)))
...
-- Equation(s):
-- \i2|s~0_combout\ = \b[2]~input_o\ $ (\a[2]~input_o\ $ (\i1|cout~0_combout\))
...
\i3|s\ : cycloneive_lcell_comb
-- Equation(s):
-- \i3|s~combout\ = \a[3]~input_o\ $ (\b[3]~input_o\ $ (\i2|cout~0_combout\))
...
-- Equation(s):
-- \i3|cout~0_combout\ = (\a[3]~input_o\ & ((\b[3]~input_o\) # (\i2|cout~0_combout\))) # (!\a[3]~input_o\ & (\b[3]~input_o\ & \i2|cout~0_combout\))
