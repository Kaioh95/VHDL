...
-- Equation(s):
-- \LessThan0~1_cout\ = CARRY((!tot_saida(0) & \s[0]~input_o\))
...
-- Equation(s):
-- \LessThan0~3_cout\ = CARRY((tot_saida(1) & ((!\LessThan0~1_cout\) # (!\s[1]~input_o\))) # (!tot_saida(1) & (!\s[1]~input_o\ & !\LessThan0~1_cout\)))
...
-- Equation(s):
-- \LessThan0~5_cout\ = CARRY((tot_saida(2) & (\s[2]~input_o\ & !\LessThan0~3_cout\)) # (!tot_saida(2) & ((\s[2]~input_o\) # (!\LessThan0~3_cout\))))
...
-- Equation(s):
-- \LessThan0~7_cout\ = CARRY((tot_saida(3) & ((!\LessThan0~5_cout\) # (!\s[3]~input_o\))) # (!tot_saida(3) & (!\s[3]~input_o\ & !\LessThan0~5_cout\)))
...
-- Equation(s):
-- \LessThan0~9_cout\ = CARRY((tot_saida(4) & (\s[4]~input_o\ & !\LessThan0~7_cout\)) # (!tot_saida(4) & ((\s[4]~input_o\) # (!\LessThan0~7_cout\))))
...
-- Equation(s):
-- \LessThan0~11_cout\ = CARRY((tot_saida(5) & ((!\LessThan0~9_cout\) # (!\s[5]~input_o\))) # (!tot_saida(5) & (!\s[5]~input_o\ & !\LessThan0~9_cout\)))
...
-- Equation(s):
-- \LessThan0~13_cout\ = CARRY((tot_saida(6) & (\s[6]~input_o\ & !\LessThan0~11_cout\)) # (!tot_saida(6) & ((\s[6]~input_o\) # (!\LessThan0~11_cout\))))
...
-- Equation(s):
-- \LessThan0~14_combout\ = (tot_saida(7) & (\s[7]~input_o\ & \LessThan0~13_cout\)) # (!tot_saida(7) & ((\s[7]~input_o\) # (\LessThan0~13_cout\)))
