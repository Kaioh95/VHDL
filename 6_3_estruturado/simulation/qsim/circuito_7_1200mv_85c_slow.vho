...
-- Design Ports Information
-- d	=>  Location: PIN_F24,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \op11|c~0_combout\ : std_logic;
...
\op11|c~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \op11|c~0_combout\ = ((\a~input_o\) # (!\c~input_o\)) # (!\b~input_o\)
